...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(count) => "${count} cards";

  static String m1(error) =>
      "An error occurred while loading the cards: ${error}";

  static String m2(error) => "An error occurred while loading cards: ${error}";

  static String m3(error) => "An error occurred while loading cards: ${error}";
