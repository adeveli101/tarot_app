...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(index) => "Kart ${index}";

  static String m4(error) => "Kartlar yüklenirken bir hata oluştu: ${error}";

  static String m5(error) => "Kartlar yüklenirken hata: ${error}";

  static String m6(error) => "Kartlar yüklenirken bir hata oluştu";

  static String m7(error) => "Kariyer Yolu açılımı hatası: \$${error}";
  ...
  static String m10(count) => "Günlük ${count} Kredini Al!";

  static String m11(message) => "${message}";

  static String m12(message) => "${message}";

  static String m13(credits) => "${credits} kredi ile daha fazla fal aç";

  static String m14(count) => "${count} kredi başarıyla eklendi!";

  static String m15(time) => "Günlük ödül alındı! Sonraki ödüle: ${time}";

  static String m16(error) => "Rüya Yorumu açılımı hatası: \$${error}";
  ...
  static String m19(category, spreadType) =>
  ...
  static String m20(error) => "Dolunay açılımı hatası: \$${error}";

  static String m21(userName) => "Tekrar hoş geldin, ${userName}!";

  static String m22(error) => "At Nalı açılımı hatası: \$${error}";

  static String m23(required) =>
      "Devam etmek için ${required} krediye ihtiyacınız var. Aşağıdan daha fazla kredi satın alın.";

  static String m24(error) => "Zihin-Beden-Ruh açılımı hatası: \$${error}";

  static String m25(hours) =>
      "Bir sonraki ücretsiz fal hakkınız ${hours} saat içinde kullanılabilir olacak.";

  static String m26(time) => "Sonraki günlük ödül ${time} sonra alınabilir";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "astroLogicalCrossChallenge": MessageLookupByLibrary.simpleMessage(
      "Zorluk / Ders",
    ),
    ...
    "astroLogicalCrossDestiny": MessageLookupByLibrary.simpleMessage(
      "Kader / Sonuç",
    ),
    "astroLogicalCrossEmotional": MessageLookupByLibrary.simpleMessage(
      "Duygusal Durum",
    ),
    "astroLogicalCrossError": m0,
    "astroLogicalCrossExternal": MessageLookupByLibrary.simpleMessage(
      "Dış Etkenler",
    ),
    "astroLogicalCrossIdentity": MessageLookupByLibrary.simpleMessage(
      "Kimlik / Benlik",
    ),
    ...
    "cardsLoadingErrorGeneric": m5,
    "cards_loading_error": m6,
    ...
    "careerPathCurrent": MessageLookupByLibrary.simpleMessage("Mevcut Durum"),
    "careerPathObstacles": MessageLookupByLibrary.simpleMessage("Engeller"),
    "careerPathOpportunities": MessageLookupByLibrary.simpleMessage(
      "Fırsatlar",
    ),
    "careerPathOutcome": MessageLookupByLibrary.simpleMessage("Olası Sonuç"),
    ...
    "careerPathSpreadError": m7,
    "careerPathStrengths": MessageLookupByLibrary.simpleMessage("Güçlü Yönler"),
    ...
    "creditInfoTooltip": MessageLookupByLibrary.simpleMessage(
      "Kredi satın almak için dokunun",
    ),
    "creditsAdded": m14,
    ...
    "dailyRewardClaimedMessage": m15,
    "dailyRewardInfo": MessageLookupByLibrary.simpleMessage(
      "Bu sayaç, bir sonraki ücretsiz günlük kredinizin ne zaman alınabileceğini gösterir.",
    ),
    "dailyRewardNotificationBody": MessageLookupByLibrary.simpleMessage(
      "Mistik tokenlerin seni bekliyor. Gel ve ödülünü al!",
    ),
    "dailyRewardNotificationTitle": MessageLookupByLibrary.simpleMessage(
      "Günlük Ödül Hazır!",
    ),
    ...
    "disableNotificationsDesc": MessageLookupByLibrary.simpleMessage(
      "Bildirimleri kapatmak için lütfen uygulama ayarlarını açın.",
    ),
    "disableNotificationsTitle": MessageLookupByLibrary.simpleMessage(
      "Bildirimleri Kapat",
    ),
    ...
    "dreamInterpretationError": m16,
    "dreamInterpretationFuture": MessageLookupByLibrary.simpleMessage(
      "Rüya - Gelecek Rehberliği",
    ),
    "dreamInterpretationPast": MessageLookupByLibrary.simpleMessage(
      "Rüya - Geçmiş Bağlantısı",
    ),
    "dreamInterpretationPresent": MessageLookupByLibrary.simpleMessage(
      "Rüya - Mevcut Duygu",
    ),
    ...
    "errorMessage": m17,
    "exactAlarmPermissionDeniedText": MessageLookupByLibrary.simpleMessage(
      "\'Alarmlar ve hatırlatıcılar\' izni reddedildi. Günlük ödül bildirimlerini zamanında alabilmek için lütfen uygulama ayarlarından bu izni verin.",
    ),
    "exactAlarmPermissionDeniedTitle": MessageLookupByLibrary.simpleMessage(
      "Tam Zamanlı Alarm İzni Gerekli",
    ),
    "exactAlarmPermissionExplanation": MessageLookupByLibrary.simpleMessage(
      "Günlük ödülünüz hazır olduğunda size tam zamanında bildirim gönderebilmemiz için \'Alarmlar ve hatırlatıcılar\' iznine ihtiyacımız var. Bu izin verilmezse bildirimler gecikebilir veya hiç gelmeyebilir.",
    ),
    "exactAlarmPermissionTitle": MessageLookupByLibrary.simpleMessage(
      "İzin Gerekli",
    ),
    ...
    "fullMoonAction": MessageLookupByLibrary.simpleMessage(
      "Eylem / Bütünleşme",
    ),
    "fullMoonChallenge": MessageLookupByLibrary.simpleMessage("Dolunay Zorluk"),
    "fullMoonCulmination": MessageLookupByLibrary.simpleMessage("Tamamlanma"),
    "fullMoonHope": MessageLookupByLibrary.simpleMessage("Dolunay Umut"),
    "fullMoonObstacles": MessageLookupByLibrary.simpleMessage(
      "Bırakma Engelleri",
    ),
    ...
    "fullMoonRelease": MessageLookupByLibrary.simpleMessage(
      "Bırakılması Gereken",
    ),
    "fullMoonResultingEnergy": MessageLookupByLibrary.simpleMessage(
      "Sonuç Enerjisi",
    ),
    "fullMoonRevealed": MessageLookupByLibrary.simpleMessage("Ortaya Çıkan"),
    ...
    "horseshoeExternalInfluence": MessageLookupByLibrary.simpleMessage(
      "Dış Etkenler",
    ),
    ...
    "horseshoeSpreadError": m22,
    "horseshoeStrengths": MessageLookupByLibrary.simpleMessage("Güçler"),
    "horseshoeUserAttitude": MessageLookupByLibrary.simpleMessage(
      "Yaklaşımınız",
    ),
    ...
    "insufficientCreditsMessage": m23,
    ...
    "loadingMessage1": MessageLookupByLibrary.simpleMessage(
      "Kaderin iplikleri okunuyor...",
    ),
    "loadingMessage2": MessageLookupByLibrary.simpleMessage(
      "Kozmik enerjilere danışılıyor...",
    ),
    "loadingMessage3": MessageLookupByLibrary.simpleMessage(
      "Yıldızlar sizin için hizalanıyor...",
    ),
    "loadingMessage4": MessageLookupByLibrary.simpleMessage(
      "Semboller çözülüyor...",
    ),
    ...
    "mindBodySpiritBody": MessageLookupByLibrary.simpleMessage("Beden"),
    ...
    "mindBodySpiritError": m24,
    "mindBodySpiritMind": MessageLookupByLibrary.simpleMessage("Zihin"),
    "mindBodySpiritSpirit": MessageLookupByLibrary.simpleMessage("Ruh"),
    ...
    "nextFreeReadingInfo": m25,
    "nextReward": MessageLookupByLibrary.simpleMessage("Sonraki:"),
    "nextRewardTooltip": m26,
    ...
    "notificationPermissionDeniedText": MessageLookupByLibrary.simpleMessage(
      "Bu uygulama için bildirimler devre dışı bırakılmış. Önemli güncellemeleri almak için lütfen uygulama ayarlarından bildirimleri etkinleştirin.",
    ),
    "notificationPermissionDeniedTextShort":
        MessageLookupByLibrary.simpleMessage("Bildirim izni verilmedi."),
    "notificationPermissionDeniedTitle": MessageLookupByLibrary.simpleMessage(
      "Bildirim İzni Gerekli",
    ),
    "notifications": MessageLookupByLibrary.simpleMessage("Bildirimler"),
    "notificationsDisabledDesc": MessageLookupByLibrary.simpleMessage(
      "Etkinleştirmek veya ayarlardan yönetmek için dokunun.",
    ),
    "notificationsEnabledDesc": MessageLookupByLibrary.simpleMessage(
      "Bildirimler etkin.",
    ),
    ...
    "pastPresentFutureReadingError": m27,
    ...
    "redeemCouponTooltip": MessageLookupByLibrary.simpleMessage("Kupon Kullan"),
    ...
    "relationshipSpreadReadingError": m31,
    ...
    "yearlySpreadReadingError": m37,
    "yearlySpreadSummary": MessageLookupByLibrary.simpleMessage("Yılın Özeti"),
  };
}
