...
class TarotBloc extends Bloc<TarotEvent, TarotState> {
  ...
  Future<void> _handleReadingProcess(
      ...
      String category,
      Map<String, TarotCard> Function() drawFunction,
      String Function({
